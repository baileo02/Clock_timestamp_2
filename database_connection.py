    ...
    def create_tables(self):
        if self.acursor:
            self.acursor.execute(
                'CREATE TABLE IF NOT EXISTS employee (emp_id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE, name TEXT NOT NULL)')
            self.acursor.execute(
                'CREATE TABLE IF NOT EXISTS timestamp (clock_on TEXT, clock_off TEXT, emp_id INTEGER NOT NULL, date TEXT, record_id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE)')
